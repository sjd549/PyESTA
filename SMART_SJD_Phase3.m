...
%%%%%%%
                                    %TauR1=50ms  %TauR=50ms     %TauR=60ms
...
I_PF1_Equil=-4000;					%-4000;      %-4000;        %-4000;
I_PF2_Equil=-4000;					%-4000;      %-4000;        %-4000;
I_Div1_Equil=+4000;					%+4000;      %-5000;        %+5000;                 %(Pos for +d, Neg for -d)
...
TauR1 = 0.050;			% Breakdown Ramp Timescale  [s] Determines max loop voltage
