...
ShotName = 'S1-000020-B';		%Define shot name: typically Sx-xxxxxx"
...
Te = 250;			% Electron Temperature [eV]                     250 - 300 eV from ASTRA
Ti = Te*0.30;		% Ion Temperature      [eV]                     200 eV from ASTRA (including NBI)
BT = +03;			% Toroidal B-Field     [T] (Defined at Rgeo)
...
ne = abs(Gr_Limit*Gr_Frac);                % Electron Density         [m-3]     ~5e19 [m-3] from ASTRA
...
I_Sol_Equil=-0600;                  %-0600;      %-0900;        %-0900;
